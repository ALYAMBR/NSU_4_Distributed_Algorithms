/**
 * I made topology 3 and scenario 3. Then I looked how it all works.
 */
...
public final class Executor {
	...
	public static final void main(String[] args) {
		...
		Scenario scenario3 = new Scenario(Main.class){
			{
				command(1, "S2000:PHello, Napoleon!");
				command(2, "S3000:PHello, Alexander!");
				command(3, "S4000:LHello guys!");
			}
		};
